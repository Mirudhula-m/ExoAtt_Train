 ...
 * documentation: docs.jspsych.org
 ...
 MODIFIED ON 1/08/2020 FOR EYE TRACKING
 *
 **/
...
/*
    err_cm = 3;
    ppi = 227;  // value from jspsych
    // There are 100 pixels per inch, so cm = pixels * 2.54 / 100

    err_pixel = err_cm * ppi / 2.54;
*/
    opts.display_element.innerHTML = '<div class="jspsych-content-wrapper"><div id="jspsych-content"></div><div id ="gaze" style ="position: absolute;display:none;width: 100px;height: 100px;border-radius: 50%;border: solid 2px  rgba(255, 255,255, .2); box-shadow: 0 0 100px 3px rgba(125, 125,125, .5); pointer-events: none; z-index: 999999"></div></div>';
